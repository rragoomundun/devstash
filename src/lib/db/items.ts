...
export async function toggleItemFavorite(userId: string, itemId: string, isFavorite: boolean) {
  return prisma.item.update({
    where: { id: itemId, userId },
    data: { isFavorite },
    select: itemSelect,
...
export async function toggleItemPin(userId: string, itemId: string, isPinned: boolean) {
  return prisma.item.update({
    where: { id: itemId, userId },
    data: { isPinned },
    select: itemSelect,
